...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'units.*.conversionFactor' => ['required_with:units', 'integer', 'min:1'],
            'units.*.sellingPrice' => ['required_with:units', 'numeric', 'min:0'],
            'units.*.costPrice' => ['required_with:units', 'numeric', 'min:0'],
            'units.*.isBaseUnit' => ['required_with:units', 'boolean'],
